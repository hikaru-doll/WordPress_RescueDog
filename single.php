...
<html lang="ja">
  ...
  <body>
    ...
    <main class="single-php main">
      <div class="wrapper">
        <h1 class="single-title">お知らせタイトル</h1>
        <p class="date">2026.05.25</p>
        <div class="text">
          <p>
            今日は大学生のボランティアさんがたくさん遊んでくれました！
            運動を兼ねてと言い、いつもお手伝いをしてくれるボランティアさんには本当に感謝しています。
            犬たちもすっかり懐いてしまいました。
          </p>
          <p>
            RescueDogで保護している犬たち、中でも大型のワンコたちは、
            ご飯を用意する人より、遊んでくれる人が一番好きなようです。
            比較的若いワンコたちなので、運動がしたくてしょうがないのです。
          </p>
        </div>
        <div class="image">
          <ul class="grid">
